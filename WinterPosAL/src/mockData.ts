import { Product, Client, User, TasaHistoryItem, InventoryMovement, CompanyConfig } from './types';
...
export const mockTasaHistory: TasaHistoryItem[] = [
...
export const mockMovements: InventoryMovement[] = [
  { id: 1, date: '2026-07-15 09:12', productCode: 'ACEITE-AMA-500', productDescription: 'ACEITE AMANECER DE SOYA 500ML', type: 'Entrada', qty: 20, stock_anterior: 15, stock_posterior: 35, motivo: 'Compra a Distribuidora', usuario: 'Anderson Laguna' },
  { id: 2, date: '2026-07-15 09:30', productCode: 'LECHE-CAMP-1L', productDescription: 'LECHE COMPLETA CAMPESTRE 1L', type: 'Merma', qty: -2, stock_anterior: 5, stock_posterior: 3, motivo: 'Empaque roto / derrame en nevera', usuario: 'Alejandra Olivar' }
];
