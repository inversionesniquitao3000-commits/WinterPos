    ...
    <div className="space-y-4 text-slate-800 font-mono text-xs animate-fade-in p-6 bg-slate-50 min-h-screen">
      ...
      {activeSubTab === 'personal' ? (
        ...
        <>
          ...
          <div className="bg-white border border-slate-200 text-slate-800 p-5 rounded-2xl shadow-xs space-y-4 font-sans">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-[11px] font-extrabold uppercase tracking-wider text-blue-600">Semáforo de Cumplimiento Legal</span>
                  <h2 className="text-base font-black tracking-tight text-slate-900">Salud Legal de la Empresa en Venezuela</h2>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 flex-wrap sm:flex-nowrap">
                <div className="flex items-center gap-2 bg-slate-50 border border-slate-200 px-3.5 py-1.5 rounded-xl shadow-2xs">
                  <span className="text-xs text-slate-500 font-semibold">Estatus Global:</span>
                ...
                <button
                  ...
                  className="px-3.5 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-xl shadow-xs transition-all flex items-center gap-1.5 active:scale-95 cursor-pointer"
                >
                ...
                return (
                  <div key={req.key} className={`p-4 rounded-xl border flex items-center justify-between gap-4 transition-all ${
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      {isCompliant && docFound ? (
                        <>
                          <button
                            type="button"
                            onClick={() => setPreviewDoc(docFound)}
                            className="px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-lg shadow-sm flex items-center gap-1.5 transition-all active:scale-95 cursor-pointer"
                            title="Ver Vista Previa del Documento"
                          >
                            <Eye className="w-3.5 h-3.5" />
                            <span>Ver Previa</span>
                          </button>
                          <span className="px-2.5 py-1 bg-emerald-100 text-emerald-800 text-[11px] font-black rounded-lg border border-emerald-200">
                            EN REGLA
                          </span>
                        </>
                      ) : (
                        <button
                          ...
                          className="px-3.5 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-lg shadow-sm flex items-center gap-1.5 cursor-pointer transition-all active:scale-95"
                        >
      ...
      {previewDoc && (
        <div 
          className="fixed inset-0 bg-slate-950/85 backdrop-blur-md flex items-center justify-center p-4 font-sans z-[100] animate-in fade-in duration-200"
          style={{ zIndex: 9999 }}
        >
